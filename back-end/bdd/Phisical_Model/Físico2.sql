...
CREATE TABLE IF NOT EXISTS `archivo`.`procedure_has_person` (
  ...
  INDEX `fk_procedure_has_person_usraxis1_idx` (`usraxis_id` ASC, `usraxis_person_id` ASC) VISIBLE,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  UNIQUE INDEX `procedure_id_UNIQUE` (`procedure_id` ASC) VISIBLE,
  UNIQUE INDEX `person_id_UNIQUE` (`person_id` ASC) VISIBLE,
  UNIQUE INDEX `licence_id_UNIQUE` (`licence_id` ASC) VISIBLE,
  UNIQUE INDEX `usraxis_id_UNIQUE` (`usraxis_id` ASC) VISIBLE,
  UNIQUE INDEX `usraxis_person_id_UNIQUE` (`usraxis_person_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_procedure_has_person_usraxis1`
    FOREIGN KEY (`usraxis_id` , `usraxis_person_id`)
    REFERENCES `archivo`.`usraxis` (`id` , `person_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
